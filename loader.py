...
my_test_texts = []
my_test_texts.append("It was a painfully good")
my_test_texts.append("I want to die watching this movie")
my_test_texts.append("very very very bad movie")
my_test_labels = ["positive", "positive", "negative"]
...
def get_toy_data(batch_size=1):
    # Create dataset from toy examples only
    toy_data = pd.DataFrame({"review": my_test_texts, "sentiment": my_test_labels})
    toy_dataset = ReviewDataset(toy_data["review"], toy_data["sentiment"])
